...
module.exports = router
    ...
    .put('/:id', (req, res)  => {
        const { id } = req.params;
        const { title, mechanics: { numPlayers, minutesPerGame }, type } = req.body;
        Game.findByIdAndUpdate(id, { title, mechanics: { numPlayers, minutesPerGame }, type }).then(game => res.json(game));
    });